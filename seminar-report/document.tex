...
This integral is not directly computed, instead Algorithm~\ref{alg:thompson} is
...
This example is applied as Algorithm~\ref{alg:thompson}. We initialize
...
observed. The tilt is slighter, because the observations do not just yet
justify ruling out the large values.
...
index, which although is Bayes-optimal, can not be implemented efficiently in
